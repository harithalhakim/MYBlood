...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Update Blood Stocks</h1>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Hospital Sungai Buloh</h6>
                                </div>
  ...
  <form class="form-horizontal col-lg-6 col-md-6 col-sm-6 col-xs-6" action="updatebloodstocks.php">

      <form class="form-inline col-lg-6 col-md-6 col-sm-6 col-xs-6" action="updatebloodstocks.php">

  <div class="form-group">
    <label for="updateo-">O-</label>
    <input type="number" id="o-stock" class="form-control mx-sm-3" aria-describedby="" style="width: 80px;">
